...
They facilitate non-trusting Debtors and Creditors to close financial contracts without the need of intermediaries.
...
Section \ref{subsec:history-of-collateral-management} provides a brief exploration of the historical use of collateral in the financial sector,
...
\label{subsec:history-of-collateral-management}
...
without the need and risks of redundantly implementing the complex maths.
...
The Arcadia Financial stack is our answer to resolve the inefficiencies outlined in Paragraph \ref{subsec:inefficiencies}.
...
a correction $S_{asset}$ is again applied to bring the usd-value of the asset $V_{asset}^{usd}$ to 18 decimals precision.
