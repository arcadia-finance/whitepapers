...
It is peer-to-pool lending protocol developed by the Arcadia team.

Next 

\subsubsection{Accounting Liabilities}
The Account for which debt is taken out, will receive a debt bearing token (dbToken) which are not transferable.
